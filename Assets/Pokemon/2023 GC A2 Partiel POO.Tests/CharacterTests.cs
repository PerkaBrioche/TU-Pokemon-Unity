...
namespace _2023_GC_A2_Partiel_POO.Tests.Level_2
{
    public class CharacterTests
    {
        ...
        public void CharacterReceivePunch()
        {
            ...
            Assert.That(pikachu.CurrentHealth, Is.EqualTo(oldHealth - (punch.Power - pikachu.Defense))); // 100 - (70-30)
        ...
        public void FightWithOneTurn()
        {
            ...
            Punch p = new Punch();
            Assert.That(p.StatusPotential == StatusPotential.NONE);
          //  Assert.That(pikachu.CurrentStatus.CanAttack);
